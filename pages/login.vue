          ...
          <div class="flex items-start">
            <div class="flex items-center h-5">
              <input
                ...
                type="checkbox"
                value=""
                class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-primary-100 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-primary-400 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800"
                required
              />
            </div>
            <label
