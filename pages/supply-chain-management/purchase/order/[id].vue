  ...
  <TrumsWrapper>
        ...
        <div class="flex-1">
          <el-descriptions title="" :column="1" size="large" border>
            ...
            <el-descriptions-item label="Informasi Tambahan">
              {{ purchaseOrderData?.additinal_information ?? 'Tidak Ada' }}
            </el-descriptions-item>
          </el-descriptions>
        </div>
      </div>
      ...
      <div class="flex gap-3 my-3">
        <div class="flex-1">
          <el-descriptions title="" :column="1" size="large" border>
            ...
            <el-descriptions-item v-if="purchaseOrderData?.is_tempo" label="Tempo">
              Tempo : {{ purchaseOrderData?.term_payment + ' ' + purchaseOrderData?.term_payment_unit }}
            </el-descriptions-item>
        ...
        <div class="flex-1">
          <el-descriptions title="" :column="1" size="large" border>
            ...
            <el-descriptions-item label="Alamat Pengiriman">
              ...
              <div>{{ purchaseOrderData?.address?.city + ',' + purchaseOrderData?.address?.province + ',' + purchaseOrderData?.address?.regency }}</div>
            </el-descriptions-item>
          </el-descriptions>
        </div>
      </div>
    ...
    <el-card class="mb-3">
      ...
      <el-table :data="purchaseOrderData?.purchase_order_item ?? []" border>
        <el-table-column prop="catalogue_name" label="Item" width="350" />
