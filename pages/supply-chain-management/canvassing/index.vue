...
const columns: Column<Canvassing>[] = [
  {
    ...
    cellRenderer: ({ rowData: row }) => (
      <NuxtLink href={`canvassing/detail/${row.unique_id}`}>
        {row.unique_code}
      </NuxtLink>
    ),
  },
...
<template>
  <TrumsWrapper>
    <el-row :gutter="20" class="mb-3">
      ...
      /></el-col>
      <el-button size="large" @click="$router.push('canvassing/add')"
        >New Canvassing</el-button
      >
    </el-row>
    ...
    <div class="flex justify-end mt-3">
      <el-pagination
        ...
        :total="dataCanvassing?.total_page"
      />
    </div>
  </TrumsWrapper>
</template>
