    ...
    },
    {
      ...
      cellRenderer: ({rowData: row}) => (
        <>
          ...
          <NuxtLink href={`/sales/offer/${row.unique_id}`} class="el-button el-button--small">Detail</NuxtLink>
          <NuxtLink href={`/sales/offer/add?id=${row.unique_id}`} class="el-button el-button--small">Edit</NuxtLink>
