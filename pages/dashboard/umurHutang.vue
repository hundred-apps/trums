...
import type { HutangPiutang, UmurHutangPiutang } from '~/types/finance/hutangpiutang'
...
// Data state
const {data} = await useFetchApi<Pagination<UmurHutangPiutang>>('/laporan-umur-piutang', 'umur-hutang-piutang', 'get', null);
    ...
    <el-row>
        <el-col :span="24">
            <el-card shadow="never">
                ...
                <el-table :data="(data?.query?.hutang ?? [])" >
                    ...
                    <el-table-column prop="30" label="30 Hari" align="right" >
                        <template #default="{ row }">
                            <span class="">
                            {{ currency(row['30']) }}
                            </span>
                    ...
                    <el-table-column prop="60" label="60 Hari" align="right" >
                        <template #default="{ row }">
                            <span class="">
                            {{ currency(row['60']) }}
                            </span>
                    ...
                    <el-table-column prop="90" label="90 Hari" align="right" >
                        <template #default="{ row }">
                            <span class="">
                            {{ currency(row['90']) }}
                            </span>
        ...
        <el-col :span="24" class="mt-4">
            <el-card shadow="never">
                ...
                <el-table :data="(data?.query?.piutang ?? [])" >
                    <el-table-column prop="name" label="Contact" >
                        <template #default="{ row }">
                            <span class="text-blue-500 font-bold">
                            {{ row.customer_name }}
                    ...
                    <el-table-column prop="0" label="< 30 Hari" align="right" >
                        <template #default="{ row }">
                            <span class="">
                            {{ currency(row['0']) }}
                            </span>
