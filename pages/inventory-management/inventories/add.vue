<template>
    ...
    <el-card class="my-3">
            ...
            <el-form-item v-if="ruleForm.traceable == '0'" label="Quantity" prop="qty">
                <el-input v-model="ruleForm.qty":parser="(value: any) => value.replace(/[^0-9]/g, '')" placeholder="Quantity" />
            </el-form-item>
            ...
            <el-form-item v-if="ruleForm.traceable == '1'" label="Serial Number" prop="sn">
...
<script lang="ts" setup>
    ...
    import { type Column, type ComponentSize, type FormInstance, type FormRules, ElMessage } from 'element-plus'
