<template>
  ...
  >
    ...
    <el-form-item label="Tipe">
      <el-checkbox v-model="formData.is_personal" label="Personal" border />
      <el-checkbox v-model="formData.is_company!" label="Perusahaan" border />
    </el-form-item>
    ...
    <el-form-item>
      <div class="flex justify-start align-center">
        ...
        <el-button type="info" plain @click="$emit('reset')"> Reset </el-button>
      </div>
    </el-form-item>
  </el-form>
</template>
...
onMounted(() => console.log("contact data", props.contactData));
</script>
