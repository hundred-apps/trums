        ...
        >
          ...
          <el-form-item label="Nama" prop="name">
            <el-input
              ...
              placeholder="Masukan nama adjustment"
            />
          </el-form-item>
...
const rules = reactive<FormRules>({
  unique_code: [
    {
      required: true,
      message: "Kode unik tidak boleh kosong!",
      trigger: "blur",
    },
  ],
  name: [
    {
      required: false,
      message: "Nama adjustment tidak boleh kosong!",
      trigger: "blur",
    },
  ],
  type: [
  ...
  default_value: [
    {
      required: true,
      message: "Nilai default tidak boleh kosong!",
      trigger: "blur",
    },
    {
  ...
  operator: [
    {
      required: true,
      message: "Operator tidak boleh kosong!",
      trigger: "change",
    },
  ],
  created_at: [
    {
      required: true,
      message: "Tanggal dibuat tidak boleh kosong!",
      trigger: "change",
    },
  ],
});
