...
const styles = reactive<{
  ...
  sidebar:
    "text-gray-900 hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700 hover:text-blue-500",
});
  ...
  >
    <slot>
      <span v-if="loading"
        ><svg
          aria-hidden="true"
          :class="`text-gray-200 animate-spin dark:text-gray-600 fill-blue-600 ${selectedSize}`"
          viewBox="0 0 100 101"
          fill="none"
